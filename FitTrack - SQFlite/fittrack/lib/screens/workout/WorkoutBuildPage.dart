...
import 'package:fittrack/screens/workout/popups/TimePopup.dart';
                  ...
                  child: PopupMenuButton(
                    ...
                    onSelected: (selection) {
                      if (selection == 'remove') {
                        ...
                        workout.exerciseToReplaceIndex = index;

                        workout.exerciseToReplace = _exercise;
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      initialValue: _sets[i].weight?.toString(),
                      autofocus: false,
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      initialValue: _sets[i].reps?.toString(),
                      autofocus: false,
                      keyboardType: TextInputType.number,
                      textAlign: TextAlign.center,
                      decoration: InputDecoration(
                    ...
                    child: TextFormField(
                      ...
                      onTap: () async {
                        int time = await showTimeDialog(
                          context,
                          _exercise.sets[i].time,
                        );

                        workout.updateExerciseSetTime(index, i, time);
                      },
                    ),
                  ),
                ),
