  ...
  Widget build(BuildContext context) {
    return charts.OrdinalComboChart(
      ...
      primaryMeasureAxis: charts.NumericAxisSpec(
        renderSpec: settings.workoutsPerWeekGoal.isEnabled && workoutsCount > 0
        ...
        tickProviderSpec:
            settings.workoutsPerWeekGoal.isEnabled && workoutsCount > 0
                ? charts.StaticNumericTickProviderSpec([
                    charts.TickSpec(
                      settings.workoutsPerWeekGoal.goal,
...
List<charts.Series<WorkoutsPerWeek, String>> convertWorkoutsToChartSeries(
  ...
  void addData(DateTime date, int count) {
    ...
    targetData.add(
      WorkoutsPerWeek(
        week: getDateAsString(date),
        workoutCount: settings.workoutsPerWeekGoal.goal,
        workoutDate: date,
      ),
    );
  }
